'''
This script is used for loading the NuScenes dataset with SEED4D camera data.
It processes the dataset to extract camera images from Nuscenes but intrinsics and extrinsics from SEED4D
'''
